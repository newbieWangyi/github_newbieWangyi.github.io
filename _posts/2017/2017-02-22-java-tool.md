...
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/jconsole01.jpg)
...
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/jconsole02.jpg)


- 内存，主要展示了内存的使用情况，同时可以查看堆和非堆内存的变化值对比，也可以点击执行GC来处罚GC的执行

 
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/jconsole03.jpg)


- 线程，主界面展示线程数的活动数和峰值，同时点击左下方线程可以查看线程的详细信息，比如线程的状态是什么，堆栈内容等，同时也可以点击“检测死锁”来检查线程之间是否有死锁的情况。

 
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/jconsole04.jpg)
...
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/jvisualvm.jpg)
...
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/jvisualvm01.jpg)


VisualVM可以根据需要安装不同的插件，每个插件的关注点都不同，有的主要监控GC，有的主要监控内存，有的监控线程等。

 
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/jvisualvm02.jpg)
...
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/jvisualvm03.jpg)
...
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/jvisualvm04.jpg)

线程和jconsole功能没有太大的区别

 
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/jvisualvm05.jpg)

Visual GC 是常常使用的一个功能，可以明显的看到年轻代、老年代的内存变化，以及gc频率、gc的时间等。

 
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/jvisualvm06.jpg)

以上的功能其实jconsole几乎也有，VisualVM更全面更直观一些，另外VisualVM非常多的其它功能，可以分析dump的内存快照，dump出来的线程快照并且进行分析等，还有其它很多的插件大家可以去探索

 
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/jvisualvm07.jpg)
...
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/mat01.jpg)
...
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/mat02.jpg)

- Dominator Tree：列出最大的对象以及其依赖存活的Object （大小是以Retained Heap为标准排序的）

 
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/mat03.jpg)

- Top Consumers ： 通过图形列出最大的object

 
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/mat04.jpg)
...
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/mat05.jpg)


- Top Components: 列出大于总堆数的百分之1的报表。

 
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/mat06.jpg)
...
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/g1.jpg)

- GC Pause Stats:可以查看GC 的次数、GC的时间、GC的开销、最大GC时间和最小GC时间等，以及相应的柱状图

 
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/g2.jpg)
...
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/g3.jpg)
...
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/gv.jpg)
...
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/gceasy1.png)

 
![](http://io.dbbaxbb.cn/assets/images/2017/jvm/gceasy2.png)
...
- [jvm系列(四):jvm调优-命令篇](http://io.dbbaxbb.cn/java/2016/01/01/jvm%E8%B0%83%E4%BC%98-%E5%91%BD%E4%BB%A4%E7%AF%87.html)
...
**作者：纯洁的微笑**  
**出处：[http://io.dbbaxbb.cn/](http://io.dbbaxbb.cn/java/2017/02/22/jvm-tool.html)**      
**版权归作者所有，转载请注明出处** 
