...
<html lang="zh" xmlns:th="http://www.thymeleaf.org">
    ...
    <body>
        ...
        <a href="#" th:href="@{ http://io.dbbaxbb.cn/neo/{id}(id=${id}) }">激活账号</a>
    </body>
</html>
```
...
可以参考前期文章：[springboot(八)：RabbitMQ详解](http://io.dbbaxbb.cn/springboot/2016/11/30/springboot(%E5%85%AB)-RabbitMQ%E8%AF%A6%E8%A7%A3.html) 来实现。
...
**作者：纯洁的微笑**  
**出处：[http://io.dbbaxbb.cn/](http://io.dbbaxbb.cn/springboot/2017/05/06/springboot-mail.html)**      
**版权归作者所有，转载请注明出处** 
