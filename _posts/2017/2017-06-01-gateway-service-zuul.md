...
![](http://io.dbbaxbb.cn/assets/images/2017/springcloud/api_gateway.png)
...
![](http://io.dbbaxbb.cn/assets/images/2017/springcloud/bff.png)
...
![](http://io.dbbaxbb.cn/assets/images/2017/springcloud/bff-process.png)
...
#这里的配置表示，访问/it/** 直接重定向到http://io.dbbaxbb.cn/**
zuul.routes.baidu.path=/it/**
zuul.routes.baidu.url=http://io.dbbaxbb.cn/
```
...
启动```gateway-service-zuul-simple```项目，在浏览器中访问：```http://localhost:8888/it/spring-cloud```，看到页面返回了：```http://io.dbbaxbb.cn/spring-cloud ``` 页面的信息，如下：

 
![](http://io.dbbaxbb.cn/assets/images/2017/springcloud/zuul-01.jpg)
...
-------------
**作者：纯洁的微笑**  
**出处：[http://io.dbbaxbb.cn/](http://io.dbbaxbb.cn/springcloud/2017/06/01/gateway-service-zuul.html)**      
**版权归作者所有，转载请注明出处** 
