...
我们在[springcloud(七)：配置中心svn示例和refresh](http://io.dbbaxbb.cn/springcloud/2017/05/23/springcloud-config-svn-refresh.html)中讲到，如果需要客户端获取到最新的配置信息需要执行```refresh```，我们可以利用webhook的机制每次提交代码发送请求来刷新客户端，当客户端越来越多的时候，需要每个客户端都执行一遍，这种方案就不太适合了。使用Spring Cloud Bus可以完美解决这一问题。
...
![](http://io.dbbaxbb.cn/assets/images/2017/springcloud/configbus1.jpg)
...
我们选择上一篇文章[springcloud(八)：配置中心服务化和高可用](http://io.dbbaxbb.cn/springcloud/2017/05/25/springcloud-config-eureka.html)版本的[示例代码](https://github.com/ityouknow/spring-cloud-starter/tree/master/spring-cloud-config-eureka)来改造,MQ我们使用RabbitMQ来做示例。
...
![](http://io.dbbaxbb.cn/assets/images/2017/springcloud/configbus3.jpg)
...
![](http://io.dbbaxbb.cn/assets/images/2017/springcloud/configbus2.jpg)
...
-------------
**作者：纯洁的微笑**  
**出处：[http://io.dbbaxbb.cn/](http://io.dbbaxbb.cn/springcloud/2017/05/26/springcloud-config-eureka-bus.html)**      
**版权归作者所有，转载请注明出处** 
